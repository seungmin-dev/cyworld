    ...
    <Layout>
      ...
      <div className="w-100 pt-2">
        <div className="w-1/2 m-auto bg-zinc-100 rounded-xl border-[1px] border-zinc-400 p-5 mb-3 text-center">
          ...
          <h2 className="font-boldFont text-sm pb-1">끝말잇기</h2>
          ...
          />
          <Button onClick={lastWordGame} text="입력" />
        ...
        <div className="w-1/2 m-auto bg-zinc-100 rounded-xl border-[1px] border-zinc-400 p-5 text-center">
          ...
          <h2 className="font-boldFont text-sm pb-1">LOTTO</h2>
          ...
          <Button onClick={() => setPlayLotto(true)} text="추첨하기" />
        </div>
      </div>
    </Layout>
  );
